...
public:
    double getAverage(vector <string> vrs)
    {
        string rs = "";
        for (auto& s : vrs) rs += s;
        auto ra = splitInt(rs);
        int e = ra[0];
        vector<int> r(ra.begin() + 1, ra.end());
        sort(ALL(r));
        reverse(ALL(r));
        const int N = ra.size();
        const int R = (N + 19) / 20;
        int er = distance(r.begin(), lower_bound(ALL(r), e, [](int x, int y) { return x > y; })) / R;
        const int L = (N + R - 1) / R;
        vector<int> s(L, 0);
        vector<int> c(L, 0);
        s[er] = e;
...
int main( int argc, char* argv[] )
{
    ...
    }
    {
        ...
        vector <string> ratings( ratingsARRAY, ratingsARRAY+ARRSIZE(ratingsARRAY) );
        EllysRoomAssignmentsDiv1 theObject;
        eq(2, theObject.getAverage(ratings),1824.662456140351);
    }
    {
        string ratingsARRAY[] = {"2869 3239 1609 2367 1836 1663 1697 2317 1475 2212 ", "2188 2073 1263 1391 1495 3010 1243 2198 1782 1564 ",
        ...
        vector <string> ratings( ratingsARRAY, ratingsARRAY+ARRSIZE(ratingsARRAY) );
        EllysRoomAssignmentsDiv1 theObject;
        eq(3, theObject.getAverage(ratings),1985.7041666666669);
    }
    {
        string ratingsARRAY[] = {"1298 2272 2618 1344 3020 3212 3419 1754 3571 2835 ", "3049 2893 1970 3006 3244 3451 3273 2039 3826 2199 ", "3159"};
        vector <string> ratings( ratingsARRAY, ratingsARRAY+ARRSIZE(ratingsARRAY) );
        EllysRoomAssignmentsDiv1 theObject;
        eq(4, theObject.getAverage(ratings),2670.4545454545455);
    }
    return 0;
}
// END CUT HERE
