...
public:
    ...
    {
    	int ret = 0;
    	for (int x = L; x <= R; ++x) ret += isPrime(x) && isPali(x) ? 1 : 0;
    	return ret;
    }
};
// BEGIN CUT HERE
...
{
    {
        PalindromePrime theObject;
        eq(0, theObject.count(100, 150),2);
    }
    {
        PalindromePrime theObject;
        eq(1, theObject.count(1, 9),4);
    }
    {
        PalindromePrime theObject;
        eq(2, theObject.count(929, 929),1);
    }
    {
        PalindromePrime theObject;
        eq(3, theObject.count(1, 1),0);
    }
    {
        PalindromePrime theObject;
        eq(4, theObject.count(1, 1000),20);
    }
    return 0;
}
// END CUT HERE
